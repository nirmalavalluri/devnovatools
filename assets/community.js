...
const BLOG_POSTS = [
  {
    ...
    title: 'Cron Expression Cheat Sheet — Every Schedule You'll Ever Need',
  ...
  },
  {
    ...
    excerpt: 'Every metacharacter, quantifier, and flag explained. Plus the patterns you'll copy most often: email, URL, IP, date, phone. With a live tester.',
    date: 'Jun 2026',
    readTime: '8 min read',
