...
function injectNav(){
  ...
  nav.innerHTML=`
    ...
    <div class="nav-search-wrap">
      ...
      <input id="nav-search" class="nav-search" type="text" placeholder="Search 34+ tools..." autocomplete="off"/>
...
function injectFooter(){
  ...
  <div class="footer-bottom"><div class="footer-copy">© 2026 DevNova Tools. All rights reserved.</div><div class="footer-copy">Free forever · No login · No ads</div></div>`;
