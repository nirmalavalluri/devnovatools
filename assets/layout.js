...
const ALL_TOOLS = [
  ...
  {name:'JSON to Python',desc:'Generate Python class',path:'/json/json-to-python/',cat:'JSON & Data',catId:'json',icon:'🐍'},
  ...
  {name:'bcrypt Generator',desc:'Hash & verify bcrypt',path:'/api/bcrypt/',cat:'API & Security',catId:'api',icon:'🔐'},
  ...
  {name:'Text Escape',desc:'Escape/unescape text',path:'/text/text-escape/',cat:'Text & Parsing',catId:'text',icon:'\\n'},
  ...
  {name:'Cron Expression Tester',desc:'Test cron expressions',path:'/devops/cron-tester/',cat:'DevOps & Infra',catId:'devops',icon:'⚙️'},
  ...
  {name:'Dockerfile Formatter',desc:'Lint & format Dockerfiles',path:'/devops/dockerfile/',cat:'DevOps & Infra',catId:'devops',icon:'🐳'},
  ...
  {name:'JWT to cURL',desc:'Convert JWT request to cURL',path:'/devops/curl-generator/',cat:'DevOps & Infra',catId:'devops',icon:'💻'},
  // Frontend
  ...
  {name:'Flexbox Generator',desc:'Generate Flexbox layouts',path:'/frontend/flexbox/',cat:'Frontend Tools',catId:'frontend',icon:'↔️'},
  ...
  {name:'Responsive Breakpoints',desc:'Test responsive breakpoints',path:'/frontend/breakpoints/',cat:'Frontend Tools',catId:'frontend',icon:'📱'},
];
...
const CATS = [
  ...
  {id:'devops',name:'DevOps & Infra',icon:'⚙️',color:'#FF6B35',desc:'Cron, timestamps, YAML, Docker, Kubernetes and infra tools'},
...
function injectNav(){
  ...
  nav.innerHTML=`
    ...
    <div class="nav-search-wrap">
      ...
      <input id="nav-search" class="nav-search" type="text" placeholder="Search 78+ tools..." autocomplete="off"/>
  ...
  document.getElementById('theme-btn').addEventListener('click',()=>{
    const t=getTheme()==='dark'?'light':'dark';setTheme(t);
  });
...
function injectFooter(){
  ...
  footer.id='dnt-footer';
  footer.innerHTML=`
    <div class="footer-grid">
      <div>
        <div class="footer-brand-name">DevNova Tools</div>
        <div class="footer-tagline">Every developer tool you'll ever need.<br>Free, fast, no login required.</div>
      </div>
      <div>
        <div class="footer-col-title">JSON & Data</div>
        <ul class="footer-links">
          ...
          <li><a href="/json/csv-to-json/">CSV to JSON</a></li>
          <li><a href="/json/">All JSON Tools →</a></li>
        </ul>
      </div>
      <div>
        <div class="footer-col-title">API & Security</div>
        <ul class="footer-links">
          <li><a href="/api/jwt-decoder/">JWT Decoder</a></li>
          <li><a href="/api/base64/">Base64</a></li>
          <li><a href="/api/hash-generator/">Hash Generator</a></li>
          <li><a href="/api/uuid-generator/">UUID Generator</a></li>
          <li><a href="/api/">All API Tools →</a></li>
        </ul>
      </div>
      <div>
        <div class="footer-col-title">More Tools</div>
        <ul class="footer-links">
          <li><a href="/text/regex-tester/">Regex Tester</a></li>
          <li><a href="/devops/cron-builder/">Cron Builder</a></li>
          <li><a href="/frontend/color-converter/">Color Converter</a></li>
          <li><a href="/text/markdown-preview/">Markdown Preview</a></li>
          <li><a href="/devops/timestamp/">Timestamp Converter</a></li>
        </ul>
      </div>
    </div>
    <div class="footer-bottom">
      <div class="footer-copy">© 2026 DevNova Tools. All rights reserved. Tools are for informational use only.</div>
      <div class="footer-copy">Free forever · No login · No ads</div>
    </div>`;
